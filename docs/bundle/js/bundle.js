...
var _tab = require('./function/tab.js');

var _tab2 = _interopRequireDefault(_tab);

var _nav = require('./function/nav.js');

var _nav2 = _interopRequireDefault(_nav);

var _drawer = require('./function/drawer.js');

var _drawer2 = _interopRequireDefault(_drawer);

var _form = require('./function/form.js');

var _form2 = _interopRequireDefault(_form);

var _dialog = require('./function/dialog.js');
...
var $drawer = (0, _jquery2.default)('#js-drawer');
var $btnDrawer = (0, _jquery2.default)('#js-btn-drawer');
var $blackLayer = (0, _jquery2.default)('#js-black-layer');
...
var $inputRequired = (0, _jquery2.default)('.js-input-required');

var tooltip = '.js-tooptip',
    $tooltip = (0, _jquery2.default)(tooltip);

var $btnSubmit = (0, _jquery2.default)('#js-btn-submit');

var length = $inputRequired.length;

function form() {
  $btnSubmit.on('click', function () {
    var num = 0;

    $inputRequired.each(function (index, element) {
      if ((0, _jquery2.default)(element).val() == '') {
        num += 1;
        (0, _jquery2.default)(element).next(tooltip).attr('aria-hidden', false);
      }
      /*
       * 最後に送信するかを判断
       */
      if (index == length - 1) {
        if (num == 0) {
          $tooltip.each(function (index, element) {
            (0, _jquery2.default)(element).attr('aria-hidden', true);
          });
        } else {
          return false;
        }
...
function nav() {
  var $subNavTrigger = (0, _jquery2.default)('.js-sub-nav-trigger');
  var subNavList = '.js-sub-nav-list',
      $subNavList = (0, _jquery2.default)(subNavList);

  $subNavTrigger.on({
    'mouseenter': function mouseenter(e) {
      (0, _jquery2.default)(e.currentTarget).next(subNavList).attr('aria-hidden', false);
    },
    'mouseleave': function mouseleave(e) {
      (0, _jquery2.default)(e.currentTarget).next(subNavList).attr('aria-hidden', true);
    }
  });

  $subNavList.on({
    'mouseenter': function mouseenter(e) {
      (0, _jquery2.default)(e.currentTarget).attr('aria-hidden', false);
    },
    'mouseleave': function mouseleave(e) {
      (0, _jquery2.default)(e.currentTarget).attr('aria-hidden', true);
    }
  });
};
...
function tab() {
  var $tab = (0, _jquery2.default)('.js-tab');
  var $panel = (0, _jquery2.default)('.js-panel');

  $tab.on('click', function (e) {
    e.preventDefault();

    var $target = (0, _jquery2.default)(e.currentTarget).children();
    var currentPanel = (0, _jquery2.default)(e.currentTarget).children().data('panel');
    ...
    (0, _jquery2.default)('#' + currentPanel).attr('aria-hidden', false);
  });
};

var uiTab = { tab: tab };

exports.default = uiTab;
